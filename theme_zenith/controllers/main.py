...
class ZenithController(http.Controller):
    ...
    def brands_directory(self, **kwargs):
        ...
        brands = request.env['zenith.product.brand'].sudo().search([])
        ...
        return request.render('theme_zenith.brands_directory_page', values)

    @http.route('/theme_zenith/get_dynamic_products', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/get_products_data', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/get_branches_locations', type='json', auth='public', website=True)
    def get_branches_locations(self):
        """ Fetch all active branches with their coordinates for the map. """
        branches = request.env['zenith.branch'].sudo().search([('active', '=', True)])
        data = []
        for b in branches:
            data.append({
                'id': b.id,
    ...
    def quick_order_page(self, **kwargs):
        ...
        return request.render('theme_zenith.zenith_quick_order')

    @http.route('/theme_zenith/bulk_add_cart', type='json', auth='public', website=True)
    ...
    def shop_request_quote(self, **kwargs):
        ...
        return request.render('theme_zenith.zenith_quote_request_thanks', {
            'order': sale_order
        })

    @http.route('/theme_zenith/get_categories_info', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/get_category_tree', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/subscribe_price_tracker', type='json', auth='user', website=True)
    ...
    def llms_txt(self, **kwargs):
        ...
        if hasattr(request.env['product.template'], 'brand_id'):
             brands = request.env['zenith.product.brand'].search([], limit=10, order='product_count desc')
    ...
    @http.route('/theme_zenith/get_cart_data', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/get_upsell_products', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/submit_review', type='http', auth='public', website=True, methods=['POST'])
    ...
    @http.route('/theme_zenith/get_products_by_skus', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/get_recent_orders', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/get_user_addresses', type='json', auth='public', website=True)
    ...
    @http.route('/theme_zenith/set_delivery_address', type='json', auth='public', website=True)
