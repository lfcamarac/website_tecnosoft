...
class ZenithPortalAddresses(CustomerPortal):
    """
    ...
    def my_addresses(self, **kwargs):
        ...
        return request.render('theme_zenith.portal_my_addresses', values)
    ...
    def add_address(self, **kwargs):
        ...
        return request.render('theme_zenith.portal_address_form', values)
