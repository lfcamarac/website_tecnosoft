# Zenith Server Tuning Guide (Odoo 18.0)

To ensure maximum performance for the Zenith eCommerce theme, follow these configuration guidelines in your `odoo.conf` file.
