...
AIGeneratorDialog.template = "theme_zenith.AIGeneratorDialog";
...
AIClientAction.template = "theme_zenith.AIClientAction";
AIClientAction.components = { AIGeneratorDialog };

registry.category("actions").add("theme_zenith.ai_generator", AIClientAction);
