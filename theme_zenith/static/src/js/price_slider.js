...
export const ZenithPriceSlider = publicWidget.Widget.extend({
    selector: '.zenith-price-filter-wrapper',
    ...
    _initSlider() {
        const sliderEl = this.el.querySelector('#zenith_price_slider');
        if (!sliderEl) return;
...
registry.category("public_widgets").add("ZenithPriceSlider", ZenithPriceSlider);

export default ZenithPriceSlider;
