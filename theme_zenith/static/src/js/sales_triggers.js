...
publicWidget.registry.ZenithSalesTriggers = publicWidget.Widget.extend({
    selector: '#wrapwrap',
     ...
     */
    _initStickyCTA() {
        const stickyCTA = document.querySelector('.zenith-sticky-cta');
     ...
     */
    _initSocialProof() {
        const proof = document.querySelector('.zenith-social-proof');
        if (proof) {
            setTimeout(() => {
