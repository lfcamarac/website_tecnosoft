...
publicWidget.registry.ZenithBuyNow = publicWidget.Widget.extend({
    selector: '.js_buy_now',
    events: {
        'click': '_onBuyNow',
    },
    ...
    async _onBuyNow(ev) {
        ...
        try {
            ...
            const res = await rpc('/theme_zenith/bulk_add_cart', {
...
export default publicWidget.registry.ZenithBuyNow;
