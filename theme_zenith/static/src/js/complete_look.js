...
publicWidget.registry.ZenithCompleteLook = publicWidget.Widget.extend({
    selector: '.zenith-complete-look',
    events: {
...
export default publicWidget.registry.ZenithCompleteLook;
