...
(function() {
    ...
    const STORAGE_KEY = 'zenith_dark_mode';
    ...
    function updateIcons(isDark) {
        const icons = document.querySelectorAll('.zenith-dark-mode-toggle i');
        icons.forEach(icon => {
            if (isDark) {
        ...
        const containers = document.querySelectorAll('.zenith-dark-mode-toggle');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(ev) {
            const toggle = ev.target.closest('.zenith-dark-mode-toggle');
            if (toggle) {
                ev.preventDefault();
                ev.stopPropagation();
                toggleDarkMode();
