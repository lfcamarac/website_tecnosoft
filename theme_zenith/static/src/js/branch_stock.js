...
publicWidget.registry.ZenithBranchStock = publicWidget.Widget.extend({
    selector: '.zenith-product-page', // We need to add this class to the product page wrapper if not present, or target generic
    ...
    _fetchBranchStock: async function (productId) {
        const $container = this.$('#zenith_branch_stock_container');
        ...
        try {
            ...
            console.error("Zenith: Error fetching branch stock", e);
        } finally {
